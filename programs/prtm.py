#!/usr/bin/env Python
# Name: Joseph Olivier
PROTEINDICT = {"A":71.03711,"C":103.00919,"D":115.02694,"E":129.04259,"F":147.06841,
...
def translatetoWeight(aaSequence):
	weight = 0
	x = 1 
	while x < len(aaSequence):
		for aa in aaSequence:
			weight += PROTEINDICT[aa]
			x += 1
	return weight
